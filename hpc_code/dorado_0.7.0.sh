...
#SBATCH --output=--/CASES/01_scripts/logs/dorado_0.7.0_%j.log # Standard output and error log
...
#############################Input###################################
IN=/hpc--/data/Nanopore-Pod5/Cases-Treg-5/20240917_1258_MN32174_FAZ55036_ddd49ffc/
DORADO=/hpc--/dorado-0.7.0-linux-x64/bin/dorado
MODELPATH=--/dorado-models
MODEL=rna004_130bps_hac@v5.0.0
TRIMTYPE=hac.trimAdaptor
OUT=/hpc--/CASES/02_data/13_Cases-Treg-5/
#####################################################################
