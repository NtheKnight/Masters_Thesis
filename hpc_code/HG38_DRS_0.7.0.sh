...
#SBATCH --output=--/CASES/01_scripts/logs/human-minimap2-aligner_0.7.0_%j.log # Standard output and error log
#SBATCH -p leinecpu
...
#############################Input###################################
IN=/hpc--/CASES/02_data/13_Cases-Treg-5/
...
OUT=/hpc--/CASES/02_data/13_Cases-Treg-5/01_alignment
#####################################################################
