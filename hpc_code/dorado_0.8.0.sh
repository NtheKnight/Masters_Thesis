...
#SBATCH --output=--/CASES/01_scripts/logs/dorado_0.8.0_%j.log # Standard output and error log
...
#############################Input###################################
IN=/hpc--/data/Nanopore-Pod5/Cases-Tconv-7/20240911_1327_MN32174_FAZ54913_6b9afda9/
DORADO=/hpc--/dorado-0.8.0-linux-x64/bin/dorado
MODELPATH=--/dorado-models
MODEL=rna004_130bps_hac@v5.0.0
TRIMTYPE=hac.trimAdaptor
OUT=/hpc--/CASES/02_data/12_Cases-Tconv-7/
#####################################################################
